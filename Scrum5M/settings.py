"""
Django settings for Scrum5M project.
...
SECRET_KEY = 'django-insecure-5kz7kzz#4v6bg2034o0g7)%7(_ps@ea%uxrfc#2qp3=2chp4bg'
...
WSGI_APPLICATION = 'Scrum5M.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'SistemaWeb/static')]
